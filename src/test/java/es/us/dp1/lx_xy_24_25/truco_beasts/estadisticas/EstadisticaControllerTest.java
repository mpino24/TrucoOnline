...
public class EstadisticaControllerTest {
    ...
    void obtenerEstadisticasJugadorIdNoEncontrado() throws Exception{
        doThrow(new ResourceNotFoundException("No se encontro")).when(estadisticasService.getEstadisticasJugador(2));
        mockMvc.perform(get(BASE_URL + "/estadisticasJugador/{jugadorId}", 2))
