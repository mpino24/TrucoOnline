...
INSERT INTO Logros(id,name,descripcion,valor,metrica,imagencita, oculto) VALUES (5,'El arte del engaño', 'Engaña con tu envido 1 vez', 1, 'NUMERO_ENGANOS','http://localhost:8080/resources/images/trofeos/trofeo5.jpg', TRUE);
INSERT INTO Logros(id,name,descripcion,valor,metrica,imagencita, oculto) VALUES (6,'Alguna vez te iban a agarrar', 'Se atrapado con un envido bajo 1 vez', 1, 'ATRAPADO','http://localhost:8080/resources/images/trofeos/trofeo5.jpg', TRUE);
