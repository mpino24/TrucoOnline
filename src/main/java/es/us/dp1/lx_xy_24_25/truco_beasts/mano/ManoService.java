...
public class ManoService {
        ...
        public static void cantosTruco(CantosTruco canto) throws Exception{
            ...
            switch (canto) {
                case TRUCO: 
                    ...
                    estadoTruco.accionAlTipoTruco(manoActual, jugadorTurno, equipoCantor, secuenciaCantos, listaRondaJugador, rondaActual);
                siguienteTurno();
                break;
            case RETRUCO:
    ...
    public static void responderTruco(RespuestasTruco respuesta) throws Exception{ 
        ...
        switch (respuesta) {
            case QUIERO:
                respuestaTruco.accionRespuestaTruco(manoActual,jugadorTurno, jugadorAnterior, truco, secuenciaCantos, queTrucoEs);  
                break;
            case NO_QUIERO:
